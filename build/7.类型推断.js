...
var str1 = "i am str1"; // 等价于 let str1 : string = "i am str";
str1 = "hello";
// 用const声明的变量，类型没有拓宽
var str2 = "i am str2"; // 等价于 const str2 : "i am str2" = "i am str2"， 类型为字面量类型
...
var total = add(1, 2); //total推断为number类型
